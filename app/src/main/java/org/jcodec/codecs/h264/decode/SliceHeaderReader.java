        ...
        if (nalUnit.type == NALUnitType.IDR_SLICE) {
            ...
            if (adaptive_ref_pic_marking_mode_flag) {
                ...
                do {
                    ...
                    case 1:
                        instr = new Instruction(InstrType.REMOVE_SHORT, readUE(in,
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        instr = new Instruction(InstrType.CONVERT_INTO_LONG, readUE(in,
                                "SH: difference_of_pic_nums_minus1") + 1, readUE(in, "SH: long_term_frame_idx"));
                        break;
                    case 4:
                        instr = new Instruction(InstrType.TRUNK_LONG, readUE(in,
