...
public class AudioToolAdapter  extends BaseAdapter {
    private Context mContext;
    private List<ParseObject> values;
    public static GalleryHolder holder;

    public AudioToolAdapter(Context context, List<ParseObject> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.item_audio, null);
        ...
        holder.name.setText(mObject.getString("name"));
