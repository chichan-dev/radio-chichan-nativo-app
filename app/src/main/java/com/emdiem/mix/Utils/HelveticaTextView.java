...
public class HelveticaTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mStrokeWidth = 20.0f /** a.getFloat(R.styleable.StrokedTextView_strokeWidth, 2.0f)**/;
        ...
        Typeface plain = Typeface.createFromAsset(getContext().getAssets(), "fonts/helvetica.ttf");
