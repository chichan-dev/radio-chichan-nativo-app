...
public class MultiShrinkScroller extends FrameLayout {
     ...
     */
    private final Animator.AnimatorListener exitAnimationListner = new AnimatorListenerAdapter() {
        @Override
    ...
    public void runExpansionAnimation() {
        ...
        heightExpansion.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
        ...
        widthExpansion.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
                int val = (int) animation.getAnimatedValue();
