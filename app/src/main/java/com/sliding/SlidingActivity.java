...
public abstract class SlidingActivity extends PeekViewActivity {
    ...
    protected final void onCreate(Bundle savedInstanceState) {
        ...
        final androidx.appcompat.widget.Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
     ...
     */
    public void setFab(int color, int drawableRes, View.OnClickListener onClickListener) {
